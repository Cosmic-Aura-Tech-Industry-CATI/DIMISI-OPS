...
import { Trophy, Medal, Award, Flame, Star, Zap, Crown, Target, Search } from "lucide-react";
...
import { leaderboard, currentEmployee } from "@/lib/mock-data";
...
function EmployeeLeaderboardPage() {
  ...
  const departments = useMemo(
    () => Array.from(new Set(leaderboard.map((e) => e.department))).sort(),
    [],
  );
  ...
  return (
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {top3.map((e, i) => {
          const { Icon, ring, label } = podium[i];
